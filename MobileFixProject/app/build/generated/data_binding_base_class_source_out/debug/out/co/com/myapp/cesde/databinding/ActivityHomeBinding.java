...
public final class ActivityHomeBinding implements ViewBinding {
  ...
  private ActivityHomeBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnInicioSesion,
      @NonNull Button btnRegistro, @NonNull ConstraintLayout main, @NonNull TextView txtHome) {
  ...
  public static ActivityHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityHomeBinding((ConstraintLayout) rootView, btnInicioSesion, btnRegistro,
          main, txtHome);
    }
